...
Contrôle visuel : accueil desktop (1363 px), accueil en cadres 390 et 320 px, page site et contact en cadre 768 px. Pas de débordement horizontal constaté ; menu mobile ouvert et refermé. L’illustration s’affiche. Les erreurs observées sur ces parcours venaient de l’extension du navigateur, pas du site. Le contrôle HTTP séparé sur le build de production confirme contact 200 (canonical et métadonnées inclus), page absente 404, ancienne URL /bayonne 301, robots 200 et sitemap 200. L’aperçu de développement devenu vide après le build n’affectait pas ces réponses de production. Il s’agit d’un contrôle en navigateur de développement, pas d’une certification d’accessibilité ni d’un test sur iPhone physique.
