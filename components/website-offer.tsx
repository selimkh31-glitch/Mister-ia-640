...
export function WebsiteOffer() {
  return <section className="website-offer" id="site-web" aria-labelledby="website-title"><div className="wrap section website-offer-inner">
    <div><p className="eyebrow">VOUS DÉMARREZ VOTRE SOCIÉTÉ ?</p><h2 id="website-title">Vous lancez votre activité.<br/>Votre savoir-faire mérite d’être <span className="serif-word">vu.</span></h2><p className="website-intro">Vous avez travaillé votre projet, choisi votre nom, préparé vos premières prestations. Il vous reste à vous faire connaître. Je vous accompagne pour présenter votre activité avec un site clair. La formation incluse permet ensuite à vous ou à vos employés de le modifier : l’accompagnement vise aussi votre autonomie.</p><h3>Pourquoi ce tarif ?</h3><p>Les outils de création assistée par l’IA nous permettent d’avancer plus vite sur la structure, les contenus et le développement. Nous répercutons ce temps gagné dans nos prix : un tarif adapté au travail nécessaire et au périmètre de votre projet.</p><Link className="text-link" href="/services/creation-site-web">Voir tout ce qui est inclus <ArrowUpRight size={18}/></Link></div>
