...
export default function Layout({children}:{children:React.ReactNode}){return <html lang="fr"><body><a className="skip" href="#main">Aller au contenu</a>{site.review&&<div className="review-banner">Version de présentation · Contact WhatsApp disponible.</div>}<Header/>{children}<Footer/><WhatsAppFloating/><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify({'@context':'https://schema.org','@type':'Organization','@id':absolute('/#organisation'),name:site.name,url:site.origin,description:site.description,areaServed:['Bayonne','Anglet','Biarritz','Pays Basque']})}}/></body></html>}
