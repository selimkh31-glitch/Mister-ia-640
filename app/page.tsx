import { AccompanimentVisual } from "@/components/accompaniment-visual";
...
export const metadata = pageMetadata("/", "Sites web et accompagnement IA au Pays Basque", "Un accompagnement humain pour votre entreprise.");
const questions = [
  ...
  return <main id="main" className="home-page audit-funnel">
    <section className="wrap hero">
      <div className="hero-copy">
        <p className="eyebrow">DIRIGEANTS & ÉQUIPES · ACCOMPAGNEMENT NUMÉRIQUE AU PAYS BASQUE</p>
        <h1>Votre métier d’abord. <br/><span className="serif-word">Sites web et IA</span> au Pays Basque.</h1>
        <p className="hero-intro">Vous aimez votre métier, pas les soirées à tout rattraper. Les devis, les messages, le site qu’il faudrait enfin créer… Je vous accompagne pour rendre votre activité plus visible et alléger le travail de votre équipe, avec des outils simples à prendre en main.</p>
        ...
        <p className="hero-note">Un accompagnement humain et local, avec Selimkhan. Sites internet, visibilité locale et outils IA : un besoin à la fois.</p>
      </div>
    ...
    <div className="wrap"><LocalServiceLinks/></div>
